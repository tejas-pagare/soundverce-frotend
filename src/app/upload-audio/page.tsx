...
import TopBarUploadAudio from "./_components/topBarUploadAudio";
import Step1Upload from "./_components/Step1Upload"; 
import Step2Sensitivity from "./_components/Step2Sensitivity";
    ...
    <div className="flex h-full w-full bg-[#0e0e0f] overflow-hidden ">
      <div className="flex flex-col flex-1 h-full w-full relative">
        ...
        <div className="flex-1  overflow-y-auto">
          <main className="flex flex-col px-2 sm:px-3 md:px-6 lg:px-8 xl:px-[96px] py-2 sm:py-3 gap-6  font-sans ">
