...
export default function Topbar() {
  ...
  return (
    <header className="relative w-full h-[160px] sm:h-[180px] md:h-[300px] lg:h-[200px] xl:h-[232px] flex flex-col py-4 mb-4 bg-[#0E0E0F] border-b border-[#383838] overflow-hidden">
      ...
      <div className="relative z-10 flex justify-end items-center w-full mt-2 lg:mt-[2px] sm:mt-4 px-4 sm:px-6 lg:px-8 ">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="bg-[#18181b] text-white border border-[#383838]">
            <DropdownMenuItem className="">Profile</DropdownMenuItem>
            <DropdownMenuItem className="">Settings</DropdownMenuItem>
            <DropdownMenuItem className=" text-red-500 font-bold">Logout</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
